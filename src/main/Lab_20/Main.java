...
public class Main {
    private static final String PATH = ".\\src\\main\\Lab_20\\War&Peace.txt";

    public static void main(String[] args) throws Exception{
        FileReader r_file = new FileReader("src/main/Lab_20/War&Peace.txt");
        Scanner sc = new Scanner(r_file);

        FileWriter w_file = new FileWriter("src/main/Lab_20/War&Peace_edited.txt");
        ...
        r_file = new FileReader("src/main/Lab_20/War&Peace_edited.txt");
